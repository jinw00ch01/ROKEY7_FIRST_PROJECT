...
def perform_task_dough_to_plate():
    ...
    # ===== 위치 정의 =====
    pos1 = posx([210, 74, 119, 91, -132, 177])
    pos2 = posx([464, 172, 119, 86, -134, -178])
    pos3 = posx([446, 78, 119, 88, -126, -179])
    pos4 = posx([446, 78, 259, 88, -126, -179])
    pos5 = posx([722, -32, 262, 124, -118, -154])
    pos6 = posx([722, -32, 420, 124, -118, -154])

    pos7 = posx([312, -114, 400, 94, -163, -179])
    pos8 = posx([312, -122, 312, 97, -161, -179])
    pos9 = posx([316, -145, 255, 94, -162, -177])
